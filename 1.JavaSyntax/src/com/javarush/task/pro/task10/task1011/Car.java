...
public class Car {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lamborghini2.hashCode() == lamborghini1.hashCode());
        System.out.println(ferrari.hashCode() == ferrari1.hashCode());
        System.out.println(bugatti.hashCode() == bugatti1.hashCode());
        System.out.println(bugatti.hashCode() == lamborghini2.hashCode());
        System.out.println(lamborghini2.hashCode() == ferrari.hashCode());
    }
}
